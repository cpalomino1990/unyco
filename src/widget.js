...
import {toggleReadOnHover} from './button/readPageAloud';
...
function initWidget(accountId) {
  ...
  mainMenu.append(
    ...
    createButton("btn-sicromotriz", "Sicromotriz", () => switchView("view-sicromotriz"), true)
  );

  const views = ["visual", "auditory", "navigation", "sicromotriz"].map(view => {
